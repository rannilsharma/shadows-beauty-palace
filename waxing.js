...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    if (snapshot.empty) {
      container.innerHTML = "<p>No waxing services found.</p>";
      return;
    }
    ...
    console.error("Error loading waxing services:", err);
    container.innerHTML = "<p>Error loading waxing services. Please try again later.</p>";
  }
});
